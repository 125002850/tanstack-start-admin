...
description: oig tanstack admin 团队开发规范与任务路由。分析、设计、修改或审查本仓库代码，处理 React 页面、Shadcn UI、表单、SearchCombobox、overlay portal、Card、PageContainer、DataTable、路由导航、workspace tabs、SSO 会话与菜单权限、环境配置、OpenAPI/API transport，或创建 Git 提交时使用。
---
