...
Pass object test options as the second argument. Vitest 4.1.10 still supports a numeric timeout as the third argument; the removed form is an options object in the third argument.
