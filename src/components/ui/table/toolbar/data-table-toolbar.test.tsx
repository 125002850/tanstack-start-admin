...
vi.mock('@/components/ui/table/filters/data-table-faceted-filter', () => ({
...
vi.mock('@/components/ui/table/filters/data-table-date-filter', () => ({
...
vi.mock('@/components/ui/table/filters/data-table-slider-filter', () => ({
